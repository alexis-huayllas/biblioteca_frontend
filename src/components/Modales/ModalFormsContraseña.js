...
const ModalFormsContraseña = ({boton,titulo,handleSubmitdata,initForm,Formudata}) => {
...
const MySweetAlert = withReactContent(Swal);
  ...
  const handleSubmitdataeject = (e) => {
    ...
    if(verificar.valor===false){
      ...
      axios.patch(verificar.url,verificar.formulario)
      ...
      .catch((error)=>{SweetAlertHandler({titulo:'Error',texto:'Ocurrio un error al guardar'+error,icono:'error'});});
    }
...
export default ModalFormsContraseña;
